...
const Navbar = () => {
    ...
    return (
        ...
        <ul className={!menuIsOpened ? 'sidenav' : 'sidenav visible'}> 
            <li className="sidenav-item"><Link onClick={() => dispatch(toggleMenu())} to={'/'}>Home</Link></li>
            <li className="sidenav-item"><Link onClick={() => dispatch(toggleMenu())} to={'/about'}>About</Link></li>
        </ul>
        </>
